...
treeSE = openSE.Get("monoHbb_Topmu_boosted")
...
leg.AddEntry(h_TopMatchFinal, "Top (mtch.) (31.61%)", "f")
...
leg.AddEntry(h_WmatchFinal, "Top (W-mtch.) (9.32%)","f")
...
leg.AddEntry(h_unmatchFinal, "Top (unmtch.) (59.07%)","f")
...
h_ttPassed.SetMaximum(450.0)
leg2.AddEntry(h_ttPassed, "t#bar{t} mistag (18.36%)", "f")
...
lt3.DrawLatexNDC(0.23,0.8,"#scale[0.7]{#bf{t#bar{t} CR (#mu)}}")
