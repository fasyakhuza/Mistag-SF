...
ttHad_path = "topTestSample_all_v2/combined/combined_crab_TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_forTopMu.root"
...
MET_path = "topTestSample_all_v2/combined/combined_data_MET.root"
...
SubtractedData = h_MET - (h_sumWJets + h_sumDiboson + h_ttHad + h_ttLep)
SubtractedDataPassed = h_MET_Passed - (h_sumWJetsPassed + h_sumDibosonPassed + h_ttHadPassed + h_ttLepPassed)
SubtractedDataFailed = h_MET_Failed - (h_sumWJetsFailed + h_sumDibosonFailed + h_ttHadFailed + h_ttLepFailed)
...
h_MET.GetXaxis().SetTitle("Double b score")
h_MET.GetYaxis().SetTitle("Events/Bin")
h_MET.SetMaximum(totalmax)
...
lt.DrawLatexNDC(0.23,0.8,"#scale[0.7]{#bf{t#bar{t} CR (#mu)}}")
...
#c1.Modified()
c1.Update()
c1.SaveAs("new_output/Topmu_unsubtracted.pdf")
...
#c2.Modified()
c2.Update()
c2.SaveAs("new_output/Topmu_subtracted.pdf")
...
lt5 = TLatex()
lt5.DrawLatexNDC(0.21,0.72,"#scale[2.0]{SF = 0.79}")
lt5.Draw()

c3.Modified()
c3.Update()
c3.SaveAs("new_output/Topmu_SF.pdf")
